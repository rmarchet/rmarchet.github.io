import{r as i,j as e}from"./react-B2MP_kRR.js";import{c as Ne}from"./react-dom-BkK_s-8w.js";import{u as Se,F as Ae}from"./react-full-screen-C92leYY5.js";import{d as De,w as Re,u as fe,a as je,C as Oe,O as we}from"./@react-three-vNgos8Gk.js";import{a1 as Le,g as G,a2 as Ce,a3 as ie,n as ce,o as Ue,v as Me,t as Be,a4 as Pe,h as Fe}from"./three-BhR9ud7Z.js";import{M as He}from"./react-tooltip-D_F62iJD.js";/* empty css                     */import"./classnames-CIaAGU0w.js";import"./fscreen-CK07arYI.js";import"./react-use-measure-9yo6gGM-.js";import"./its-fine-BaoiJ6Fa.js";import"./react-reconciler-DwF3unMS.js";import"./scheduler-DV1PgV85.js";import"./@babel-CF3RwP-h.js";import"./three-stdlib-BuZqK12t.js";import"./postprocessing-3619mF8q.js";import"./zustand-qjm6-URX.js";import"./use-sync-external-store-BYZj_IeE.js";import"./@floating-ui-DAnteMKF.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))u(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const _ of c.addedNodes)_.tagName==="LINK"&&_.rel==="modulepreload"&&u(_)}).observe(document,{childList:!0,subtree:!0});function r(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function u(l){if(l.ep)return;l.ep=!0;const c=r(l);fetch(l.href,c)}})();const Ke=`varying vec2 vUv;
...
${Ze}
${qe}
`,et=""+new URL("star_noise-mIq4zipT.png",import.meta.url).href,tt=""+new URL("milkyWay6MP-DWPkOyyM.jpg",import.meta.url).href,ge=""+new URL("accretion_disk_natural-DmWwv7Qb.png",import.meta.url).href,nt=""+new URL("accretion_disk_natural2-OF_9itZk.png",import.meta.url).href,ot=""+new URL("accretion_disk_red_white-BvQN-yKv.png",import.meta.url).href,rt=""+new URL("accretion_disk_red_white_purple-Cs4LHhRI.png",import.meta.url).href,at=""+new URL("accretion_disk_arrows-CtafHLH1.png",import.meta.url).href,lt=""+new URL("accretion_disk_yellow-Cd9PJf-N.png",import.meta.url).href,st=""+new URL("accretion_disk_bright-Cp1TZaoy.png",import.meta.url).href,it=""+new URL("accretion_disk_blue-DIABYurC.png",import.meta.url).href,ct=""+new URL("accretion_disk_grid-CAe8vKFG.png",import.meta.url).href,dt=""+new URL("accretion_disk_gridlines-D89IPeHo.png",import.meta.url).href,ut=""+new URL("accretion_disk_chaotic-D8VXfHzu.png",import.meta.url).href,pt=""+new URL("accretion_disk_thermal-BAYCdSjz.png",import.meta.url).href,mt=""+new URL("accretion_disk_dust-Cux3p8BK.png",import.meta.url).href,te={starUrl:et,milkywayUrl:tt,diskNaturalUrl:ge},f={NO_DISK:{value:"no_disk",label:"No Disk"},NONE:{value:"none",label:"No Texture (Blackbody)"},NATURAL:{value:"accretion_disk_natural.png",label:"Natural"},NATURAL2:{value:"accretion_disk_natural2.png",label:"Natural 2"},RED_STRIPES:{value:"accretion_disk_red_white.png",label:"Red stripes"},RED_PURPLE_STRIPES:{value:"accretion_disk_red_white_purple.png",label:"Red-Purple stripes"},GRID:{value:"accretion_disk_grid.png",label:"Checkboard"},GRID_LINES:{value:"accretion_disk_gridlines.png",label:"Grid lines"},THERMAL:{value:"accretion_disk_thermal.png",label:"Thermal"},ARROWS:{value:"accretion_disk_arrows.png",label:"Arrows"},CHAOTIC:{value:"accretion_disk_chaotic.png",label:"Turbulence"},YELLOW:{value:"accretion_disk_yellow.png",label:"Yellow"},BLUE:{value:"accretion_disk_blue.png",label:"Blue"},BRIGHT:{value:"accretion_disk_bright.png",label:"Bright"},DUST:{value:"accretion_disk_dust.png",label:"Dust"}},_t={[f.NATURAL.value]:ge,[f.NATURAL2.value]:nt,[f.RED_STRIPES.value]:ot,[f.RED_PURPLE_STRIPES.value]:rt,[f.GRID.value]:ct,[f.GRID_LINES.value]:dt,[f.ARROWS.value]:at,[f.YELLOW.value]:lt,[f.BLUE.value]:it,[f.BRIGHT.value]:st,[f.CHAOTIC.value]:ut,[f.THERMAL.value]:pt,[f.DUST.value]:mt},ht=Object.values(f),Z={DEFAULT_INTENSITY:.3,MIN_INTENSITY:.005},ne={ROTATION:{MIN:-.998,MAX:.998,DEFAULT:.9}},I={ORBIT:{RADIUS:9.5,SPEED:.2},DISTANCE:{MIN:5,MAX:15},INITIAL:{X:0,Y:1,Z:10}},ft={TIME:.2},de={HIGH:{steps:350,segments:64,stepSize:.08},LOW:{steps:140,segments:18,stepSize:.12}},a={BLOOM:{ENABLED:!0,INTENSITY:1.5,THRESHOLD:.3,RADIUS:.8},BEAMING:{ENABLED:!0},STARS:{ENABLED:!0},MILKYWAY:{ENABLED:!0},ORBIT:{ENABLED:!1},PERFORMANCE:{ENABLED:!0},DISK:{INTENSITY:1,DOPPLER_SHIFT:!0,INNER_RADIUS:2.45,WIDTH:4,DOPPLER_INTENSITY:1,BEAMING_INTENSITY:1},GLOW:{INTENSITY:0},BLACK_HOLE:{ROTATION:ne.ROTATION.DEFAULT,RELATIVISTIC_JET:!1},FOV:60},ue={performance:!1,bloom:!0,effects:!0,disk:!0,textures:!0,camera:!1},pe={enabled:a.BLOOM.ENABLED},$={intensity:a.GLOW.INTENSITY,min:0,max:3,step:.1},C={intensity:a.DISK.INTENSITY,beaming:a.BEAMING.ENABLED,dopplerShift:a.DISK.DOPPLER_SHIFT,diskTexture:f.CHAOTIC.value},Q={stars:a.STARS.ENABLED,milkyway:a.MILKYWAY.ENABLED},me={orbit:!1},_e={enabled:!0},m={bloomIntensity:{min:0,max:2,step:.1,default:1},bloomThreshold:{min:0,max:1,step:.1,default:.5},bloomRadius:{min:0,max:1,step:.1,default:.9},diskIntensity:{min:.1,max:2,step:.1},diskInnerRadius:{min:2,max:3.5,step:.1,default:a.DISK.INNER_RADIUS},diskWidth:{min:2,max:6.5,step:.1,default:a.DISK.WIDTH}},be="blackhole",g=!1,oe="localStorageChange",gt=o=>{window.dispatchEvent(new CustomEvent(oe,{detail:{key:o}}))};function s(o,t,r={}){const{reloadOnChange:u=!1,reloadDelay:l=100}=r,c=`${be}_${o}`,_=i.useRef(null),[p,E]=i.useState(()=>{try{const d=localStorage.getItem(c);return _.current=d,d?JSON.parse(d):t}catch(d){return console.error(`Error reading from localStorage: ${d}`),t}});return i.useEffect(()=>{try{const d=JSON.stringify(p);d!==_.current&&(localStorage.setItem(c,d),_.current=d,gt(c))}catch(d){console.error(`Error writing to localStorage: ${d}`)}},[c,p]),[p,d=>{try{const b=d instanceof Function?d(p):d;E(b),u&&setTimeout(()=>{window.location.reload()},l)}catch(b){console.error(`Error updating localStorage: ${b}`)}}]}function bt(o,t,r={}){return s(o,t,r)}function vt(o=be){const[t,r]=i.useState({}),u=i.useRef({});return i.useEffect(()=>{const l=()=>{const p={};let E=!1;for(let x=0;x<localStorage.length;x++){const d=localStorage.key(x);if(d&&d.startsWith(o))try{const b=d.slice(o.length+1),R=localStorage.getItem(d),S=R?JSON.parse(R):null;p[b]=S,JSON.stringify(u.current[b])!==JSON.stringify(S)&&(E=!0)}catch(b){console.error(`Error parsing localStorage item: ${b}`)}}(E||Object.keys(p).length!==Object.keys(u.current).length)&&(u.current=p,r(p))};l();const c=p=>{(!p.key||p.key.startsWith(o))&&l()},_=p=>{var E,x;(x=(E=p.detail)==null?void 0:E.key)!=null&&x.startsWith(o)&&l()};return window==null||window.addEventListener("storage",c),window==null||window.addEventListener(oe,_),()=>{window==null||window.removeEventListener("storage",c),window==null||window.removeEventListener(oe,_)}},[o]),t}function ve(){const[o,t]=s("bloomEnabled",a.BLOOM.ENABLED,{reloadOnChange:g}),[r,u]=s("bloomIntensity",a.BLOOM.INTENSITY,{reloadOnChange:g}),[l,c]=s("bloomThreshold",a.BLOOM.THRESHOLD,{reloadOnChange:g}),[_,p]=s("bloomRadius",a.BLOOM.RADIUS,{reloadOnChange:g});return{enabled:o,intensity:r,threshold:l,radius:_,setEnabled:t,setIntensity:u,setThreshold:c,setRadius:p}}function ke(){const[o,t]=s("diskTexture",C.diskTexture,{reloadOnChange:g,reloadDelay:100}),r=o===f.RED_PURPLE_STRIPES.value,u=o===f.NONE.value,l=o===f.NO_DISK.value;return{selectedTexture:o,setSelectedTexture:t,useStripes:r,useBlackbody:u,hideDisk:l}}const kt=i.memo(({enabled:o,intensity:t,threshold:r,radius:u})=>e.jsx(De,{children:e.jsx(Re,{intensity:o?t:0,luminanceThreshold:r,luminanceSmoothing:.99,radius:u,mipmapBlur:!0,kernelSize:1})})),xt=()=>{const o=i.useRef(null),t=i.useRef(null),{camera:r,gl:u,scene:l}=fe(),{enabled:c,intensity:_,threshold:p,radius:E}=ve(),[x]=s("glowIntensity",a.GLOW.INTENSITY),d=x>0,{selectedTexture:b,useBlackbody:R,hideDisk:S}=ke(),[U]=s("beamingEnabled",a.BEAMING.ENABLED),[M]=s("starsEnabled",a.STARS.ENABLED),[j]=s("milkywayEnabled",a.MILKYWAY.ENABLED),[B]=s("orbitEnabled",a.ORBIT.ENABLED),[W]=s("performanceMode",a.PERFORMANCE.ENABLED),[P]=s("diskIntensity",a.DISK.INTENSITY),[Y]=s("dopplerShiftEnabled",a.DISK.DOPPLER_SHIFT),[q]=s("dopplerIntensity",a.DISK.DOPPLER_INTENSITY),[ee]=s("beamingIntensity",a.DISK.BEAMING_INTENSITY),[F]=s("blackHoleRotation",a.BLACK_HOLE.ROTATION),[z]=s("jetEnabled",a.BLACK_HOLE.RELATIVISTIC_JET),[H]=s("diskIn",a.DISK.INNER_RADIUS),[A]=s("diskWidth",a.DISK.WIDTH),D=i.useMemo(()=>{const h=new Le,v=(L,T)=>{const N=h.load(L);return N.magFilter=T,N.minFilter=T,N.wrapS=ie,N.wrapT=ie,N},w=_t[b]||te.diskNaturalUrl;return{bgTexture:v(te.milkywayUrl,Ue),starTexture:v(te.starUrl,ce),diskTexture:v(w,ce)}},[b]);i.useEffect(()=>{r.position.set(I.INITIAL.X,I.INITIAL.Y,I.INITIAL.Z),r.lookAt(0,0,0),r==null||r.addEventListener("change",()=>{const h=r.position.length();if(h>I.DISTANCE.MAX){const v=I.DISTANCE.MAX/h;r.position.multiplyScalar(v)}else if(h<I.DISTANCE.MIN){const v=I.DISTANCE.MIN/h;r.position.multiplyScalar(v)}})},[r]);const O=i.useMemo(()=>W?de.LOW:de.HIGH,[W]),J={time:{value:0},fov:{value:a.FOV},accretion_disk:{value:!S},use_disk_texture:{value:!R},lorentz_transform:{value:!0},doppler_shift:{value:Y},beaming:{value:U},bg_intensity:{value:j?Z.DEFAULT_INTENSITY:Z.MIN_INTENSITY},show_stars:{value:M},show_milkyway:{value:j},disk_intensity:{value:P},bloom_intensity:{value:_},bloom_threshold:{value:p},bloom_radius:{value:E},glow_intensity:{value:d?x:0},black_hole_rotation:{value:F},jet_enabled:{value:z},orbit_enabled:{value:B},DISK_IN:{value:H},DISK_WIDTH:{value:A},doppler_intensity:{value:q},beaming_intensity:{value:ee},thermal_colormap_mode:{value:b===f.THERMAL.value}},V=()=>{const h=`
      #define STEP ${O.stepSize}
      #define NSTEPS ${O.steps}
    `;return new Me({vertexShader:Ke,fragmentShader:h+Qe,uniforms:{resolution:{value:new Fe(u.domElement.width,u.domElement.height)},cam_pos:{value:new G(0,3,10)},cam_dir:{value:new G(0,0,-1)},cam_up:{value:new G(0,1,0)},cam_vel:{value:new G(0,0,0)},bg_texture:{value:D.bgTexture},star_texture:{value:D.starTexture},disk_texture:{value:D.diskTexture},...J},transparent:!1,depthWrite:!0,blending:Pe,side:Be})};return i.useEffect(()=>{t.current&&(t.current.uniforms.disk_texture.value=D.diskTexture,t.current.needsUpdate=!0)},[D.diskTexture]),i.useEffect(()=>{t.current&&(t.current.uniforms.accretion_disk.value=!S,t.current.needsUpdate=!0)},[S]),i.useEffect(()=>{t.current&&(t.current.uniforms.bloom_intensity.value=_,t.current.uniforms.bloom_threshold.value=p,t.current.uniforms.bloom_radius.value=E,t.current.needsUpdate=!0)},[_,p,E]),i.useEffect(()=>{t.current&&(t.current.uniforms.beaming.value=U,t.current.needsUpdate=!0)},[U]),i.useEffect(()=>{t.current&&(t.current.uniforms.show_stars.value=M,t.current.needsUpdate=!0)},[M]),i.useEffect(()=>{t.current&&(t.current.uniforms.bg_intensity.value=j?Z.DEFAULT_INTENSITY:Z.MIN_INTENSITY,t.current.needsUpdate=!0)},[j]),i.useEffect(()=>{t.current&&(t.current.uniforms.disk_intensity.value=P,t.current.needsUpdate=!0)},[P]),i.useEffect(()=>{t.current&&(t.current.uniforms.doppler_shift.value=Y,t.current.needsUpdate=!0)},[Y]),i.useEffect(()=>{t.current&&(t.current.uniforms.glow_intensity.value=d?x:0,t.current.needsUpdate=!0)},[d,x]),i.useEffect(()=>{t.current&&(t.current.uniforms.black_hole_rotation.value=F,t.current.needsUpdate=!0)},[F]),i.useEffect(()=>{t.current&&(t.current.uniforms.jet_enabled.value=z,t.current.needsUpdate=!0)},[z]),i.useEffect(()=>{t.current&&(t.current.uniforms.DISK_IN.value=H,t.current.uniforms.DISK_WIDTH.value=A,t.current.needsUpdate=!0)},[H,A]),i.useEffect(()=>{if(t.current){const h=V();t.current.fragmentShader=h.fragmentShader,t.current.uniforms=h.uniforms,t.current.needsUpdate=!0}},[W]),i.useEffect(()=>{t.current&&(t.current.uniforms.thermal_colormap_mode.value=b===f.THERMAL.value,t.current.needsUpdate=!0)},[b]),je(h=>{if(t.current){const v=t.current.uniforms;v.time.value=h.clock.elapsedTime*ft.TIME;const w=u.domElement.width,L=u.domElement.height;if((v.resolution.value.x!==w||v.resolution.value.y!==L)&&v.resolution.value.set(w,L),B){const T=h.clock.elapsedTime*I.ORBIT.SPEED,N=Math.sin(T)*I.ORBIT.RADIUS,X=Math.cos(T)*I.ORBIT.RADIUS;r.position.set(N,1,X),r.lookAt(0,0,0)}if(!B){const T=r.position.length();if(T>I.DISTANCE.MAX){const N=I.DISTANCE.MAX/T;r.position.multiplyScalar(N)}else if(T<I.DISTANCE.MIN){const N=I.DISTANCE.MIN/T;r.position.multiplyScalar(N)}}v.cam_pos.value.copy(r.position),v.cam_dir.value.copy(r.getWorldDirection(new G)),v.cam_up.value.copy(r.up)}}),i.useEffect(()=>{const h=new Ce(16777215,2,100);return h.position.set(0,0,0),l.add(h),()=>{l.remove(h)}},[l]),e.jsxs(e.Fragment,{children:[e.jsxs("mesh",{ref:o,children:[e.jsx("sphereGeometry",{args:[20,O.segments,O.segments]}),e.jsx("shaderMaterial",{ref:t,...V()})]}),e.jsx(kt,{enabled:c,intensity:_,threshold:p,radius:E})]})},xe=[0,5,15],Et=60,It=.1,yt=1e3,Tt=25,he=Tt*(Math.PI/180),Nt=new G(Math.sin(he),Math.cos(he),0),St={enablePan:!0,minDistance:3,maxDistance:13,rotateSpeed:.65,zoomSpeed:.5},At=()=>{const{camera:o}=fe();return i.useEffect(()=>{o.position.set(...xe),o.up.copy(Nt),o.lookAt(0,0,0)},[o]),null},Dt=()=>{const o=i.useRef(null);return e.jsxs(Oe,{className:"canvas",camera:{position:xe,fov:Et,near:It,far:yt},gl:{antialias:!0,alpha:!1},children:[e.jsx(At,{}),e.jsx(we,{ref:o,...St}),e.jsx(xt,{})]})},y={DOWN:"▼",UP:"▲",RIGHT:"▶"},Rt=({onFullScreen:o})=>{const[t,r]=i.useState(!1),{intensity:u,threshold:l,radius:c,setIntensity:_,setThreshold:p,setRadius:E}=ve(),[x,d]=s("glowIntensity",$.intensity,{reloadOnChange:g}),b=x>0,[R,S]=s("bloomEnabled",pe.enabled,{reloadOnChange:g}),{selectedTexture:U,setSelectedTexture:M}=ke(),[j,B]=s("beamingEnabled",C.beaming,{reloadOnChange:g}),[W,P]=s("starsEnabled",Q.stars,{reloadOnChange:g}),[Y,q]=s("milkywayEnabled",Q.milkyway,{reloadOnChange:g}),[ee,F]=s("orbitEnabled",me.orbit,{reloadOnChange:g}),[z,H]=s("performanceMode",_e.enabled,{reloadOnChange:g}),[A,D]=s("diskIntensity",C.intensity,{reloadOnChange:g}),[O,J]=s("dopplerShiftEnabled",C.dopplerShift,{reloadOnChange:g}),[V,h]=s("dopplerIntensity",a.DISK.DOPPLER_INTENSITY,{reloadOnChange:g}),[v,w]=s("beamingIntensity",a.DISK.BEAMING_INTENSITY,{reloadOnChange:g}),[L,T]=s("blackHoleRotation",a.BLACK_HOLE.ROTATION,{reloadOnChange:g}),[N,X]=bt("jetEnabled",a.BLACK_HOLE.RELATIVISTIC_JET,{reloadOnChange:g}),[k,re]=i.useState(ue),[ae,Ee]=s("diskIn",m.diskInnerRadius.default,{reloadOnChange:g}),[le,Ie]=s("diskWidth",m.diskWidth.default,{reloadOnChange:g}),K=n=>{re(se=>({...se,[n]:!se[n]}))},ye=n=>{n.stopPropagation(),M(n.target.value)},Te=n=>{n.stopPropagation(),localStorage.clear(),d($.intensity),S(pe.enabled),B(C.beaming),P(Q.stars),q(Q.milkyway),F(me.orbit),H(_e.enabled),D(C.intensity),J(C.dopplerShift),_(m.bloomIntensity.default),p(m.bloomThreshold.default),E(m.bloomRadius.default),T(a.BLACK_HOLE.ROTATION),X(a.BLACK_HOLE.RELATIVISTIC_JET),M(f.CHAOTIC.value),h(a.DISK.DOPPLER_INTENSITY),w(a.DISK.BEAMING_INTENSITY),re(ue)};return e.jsxs(e.Fragment,{children:[e.jsx(He,{id:"controls-tooltip",className:"controls-tooltip",place:"right",offset:15}),e.jsx("nav",{className:`controls-container ${t?"collapsed":""}`,children:e.jsxs("div",{className:"controls-panel","data-augmented-ui":"  tl-clip bl-clip  b-clip br-clip tr-2-clip-x border",children:[e.jsx("header",{className:"controls-header",children:e.jsxs("div",{className:"collapse-button",onClick:()=>r(!t),children:[e.jsx("img",{src:"/icon.svg",alt:"App Icon",style:{width:24,height:24,marginRight:8}}),e.jsx("span",{children:"Controls"}),t?y.DOWN:y.UP]})}),e.jsxs("div",{className:`controls-content ${t?"hidden":""}`,children:[e.jsxs("button",{id:"button-performance","data-augmented-ui":"border tl-clip tr-clip",className:"controls-title",onClick:()=>K("performance"),"aria-controls":"section-performance","aria-expanded":k.performance,children:[e.jsx("h3",{id:"title-performance",children:"Performance Controls"})," ",k.performance?y.DOWN:y.RIGHT]}),k.performance&&e.jsx("section",{id:"section-performance","aria-labelledby":"title-performance",children:e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"checkbox-label","data-tooltip-id":"controls-tooltip","data-tooltip-content":"Reduces quality to improve performance",children:[e.jsx("span",{children:"Performance Mode"}),e.jsx("input",{"data-augmented-ui":"border tl-clip br-clip",type:"checkbox",checked:z,onChange:n=>H(n.target.checked)})]})})}),e.jsxs("button",{id:"button-bloom","data-augmented-ui":"border tl-clip tr-clip",className:"controls-title bloom-controls-title",onClick:()=>K("bloom"),"aria-controls":"section-bloom","aria-expanded":k.bloom,children:[e.jsx("h3",{id:"title-bloom",children:"Bloom Controls"})," ",k.bloom?y.DOWN:y.RIGHT]}),k.bloom&&e.jsxs("section",{id:"section-bloom","aria-labelledby":"title-bloom",className:"bloom-controls",children:[e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"checkbox-label",children:[e.jsx("span",{children:"Bloom"}),e.jsx("input",{"data-augmented-ui":"border tl-clip br-clip",type:"checkbox",checked:R,onChange:n=>S(n.target.checked)})]})}),R&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"slider-label",children:[e.jsx("span",{children:"Intensity:"}),e.jsx("input",{type:"range",min:m.bloomIntensity.min,max:m.bloomIntensity.max,step:m.bloomIntensity.step,value:u,onChange:n=>_(parseFloat(n.target.value)),className:"slider-input"}),e.jsx("span",{children:u.toFixed(2)})]})}),e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"slider-label",children:[e.jsx("span",{children:"Threshold:"}),e.jsx("input",{type:"range",min:m.bloomThreshold.min,max:m.bloomThreshold.max,step:m.bloomThreshold.step,value:l,onChange:n=>p(parseFloat(n.target.value)),className:"slider-input"}),e.jsx("span",{children:l.toFixed(2)})]})}),e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"slider-label",children:[e.jsx("span",{children:"Radius:"}),e.jsx("input",{type:"range",min:m.bloomRadius.min,max:m.bloomRadius.max,step:m.bloomRadius.step,value:c,onChange:n=>E(parseFloat(n.target.value)),className:"slider-input"}),e.jsx("span",{children:c.toFixed(2)})]})})]})]}),e.jsxs("button",{id:"button-effects","data-augmented-ui":"border tl-clip tr-clip",className:"controls-title",onClick:()=>K("effects"),"aria-controls":"section-effects","aria-expanded":k.effects,children:[e.jsx("h3",{id:"title-effects",children:"Effects Controls"})," ",k.effects?y.DOWN:y.RIGHT]}),k.effects&&e.jsxs("section",{id:"section-effects","aria-labelledby":"title-effects",children:[e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"checkbox-label",children:[e.jsx("span",{children:"Glow"}),e.jsx("input",{"data-augmented-ui":"border tl-clip br-clip",type:"checkbox",checked:b,onChange:()=>{d(b?0:1)}})]})}),b&&e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"slider-label",children:[e.jsx("span",{children:"Glow Intensity:"}),e.jsx("input",{type:"range",min:$.min,max:$.max,step:$.step,value:x,onChange:n=>d(parseFloat(n.target.value)),className:"slider-input"}),e.jsx("span",{children:(x??0).toFixed(2)})]})}),e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"checkbox-label","data-tooltip-id":"controls-tooltip","data-tooltip-html":"Shows red and blue shifts in the accretion disk",children:[e.jsx("span",{children:"Doppler Shift"}),e.jsx("input",{"data-augmented-ui":"border tl-clip br-clip",type:"checkbox",checked:O,onChange:n=>J(n.target.checked)})]})}),O&&e.jsx(e.Fragment,{children:e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"slider-label",children:[e.jsx("span",{children:"Doppler Intensity:"}),e.jsx("input",{type:"range",min:0,max:2,step:.1,value:V,onChange:n=>h(parseFloat(n.target.value)),className:"slider-input"}),e.jsx("span",{children:V.toFixed(2)})]})})}),e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"checkbox-label","data-tooltip-id":"controls-tooltip","data-tooltip-html":"Makes one side brighter and the other dimmer.<br>Only works when dopler shift is active",children:[e.jsx("span",{children:"Beaming"}),e.jsx("input",{"data-augmented-ui":"border tl-clip br-clip",type:"checkbox",checked:j,onChange:n=>B(n.target.checked)})]})}),j&&e.jsx(e.Fragment,{children:e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"slider-label",children:[e.jsx("span",{children:"Beaming Intensity:"}),e.jsx("input",{type:"range",min:0,max:2,step:.1,value:v,onChange:n=>w(parseFloat(n.target.value)),className:"slider-input"}),e.jsx("span",{children:v.toFixed(2)})]})})}),e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"checkbox-label","data-tooltip-id":"controls-tooltip","data-tooltip-html":"Toggle a relativistic jet emitted from the poles.<br>Shown when black hole rotation > 0",children:[e.jsx("span",{children:"Relativistic Jet"}),e.jsx("input",{"data-augmented-ui":"border tl-clip br-clip",type:"checkbox",checked:N,onChange:n=>X(n.target.checked)})]})}),e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"slider-label","data-tooltip-id":"controls-tooltip","data-tooltip-html":"Controls the spin of the black hole<br/>0 = non-rotating<br/>0.998 = maximum rotation CCW<br/>-0.998 = maximum rotation CW",children:[e.jsx("span",{children:"Black Hole Rotation:"}),e.jsx("input",{type:"range",min:ne.ROTATION.MIN,max:ne.ROTATION.MAX,step:.001,value:L,onChange:n=>T(parseFloat(n.target.value)),className:"slider-input"}),e.jsx("span",{children:L.toFixed(3)})]})})]}),e.jsxs("button",{id:"button-disk","data-augmented-ui":"border tl-clip tr-clip",className:"controls-title",onClick:()=>K("disk"),"aria-controls":"section-disk","aria-expanded":k.disk,children:[e.jsx("h3",{id:"title-disk",children:"Disk Controls"})," ",k.disk?y.DOWN:y.RIGHT]}),k.disk&&e.jsxs("section",{id:"section-disk","aria-labelledby":"title-disk",children:[U!=="no_disk"&&e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"slider-label",children:[e.jsx("span",{children:"Disk Intensity:"}),e.jsx("input",{type:"range",min:m.diskIntensity.min,max:m.diskIntensity.max,step:m.diskIntensity.step,value:A,onChange:n=>D(parseFloat(n.target.value)),className:"slider-input"}),e.jsx("span",{children:A==null?void 0:A.toFixed(2)})]})}),e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"slider-label",children:[e.jsx("span",{children:"Disk Inner Radius:"}),e.jsx("input",{type:"range",min:m.diskInnerRadius.min,max:m.diskInnerRadius.max,step:m.diskInnerRadius.step,value:ae,onChange:n=>Ee(parseFloat(n.target.value)),className:"slider-input"}),e.jsx("span",{children:ae.toFixed(2)})]})}),e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"slider-label",children:[e.jsx("span",{children:"Disk Width:"}),e.jsx("input",{type:"range",min:m.diskWidth.min,max:m.diskWidth.max,step:m.diskWidth.step,value:le,onChange:n=>Ie(parseFloat(n.target.value)),className:"slider-input"}),e.jsx("span",{children:le.toFixed(2)})]})})]}),e.jsxs("button",{id:"button-textures","data-augmented-ui":"border tl-clip tr-clip",className:"controls-title",onClick:()=>K("textures"),"aria-controls":"section-textures","aria-expanded":k.textures,children:[e.jsx("h3",{id:"title-textures",children:"Textures Controls"}),k.textures?y.DOWN:y.RIGHT]}),k.textures&&e.jsxs("section",{id:"section-textures","aria-labelledby":"title-textures",children:[e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"select-label",children:[e.jsx("span",{children:"Disk:"}),e.jsx("select",{"data-augmented-ui":"tl-clip bl-clip border br-clip tr-clip",value:U,onChange:ye,className:"select-input",children:ht.map(n=>e.jsx("option",{value:n.value,children:n.label},n.value))})]})}),e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"checkbox-label",children:[e.jsx("span",{children:"Stars"}),e.jsx("input",{"data-augmented-ui":"border tl-clip br-clip",type:"checkbox",checked:W,onChange:n=>P(n.target.checked)})]})}),e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"checkbox-label",children:[e.jsx("span",{children:"Milky Way"}),e.jsx("input",{"data-augmented-ui":"border tl-clip br-clip",type:"checkbox",checked:Y,onChange:n=>q(n.target.checked)})]})})]}),e.jsxs("button",{id:"button-camera","data-augmented-ui":"border tl-clip tr-clip",className:"controls-title",onClick:()=>K("camera"),"aria-controls":"section-camera","aria-expanded":k.camera,children:[e.jsx("h3",{id:"title-camera",children:"Camera Controls"}),k.camera?y.DOWN:y.RIGHT]}),k.camera&&e.jsx("section",{id:"section-camera","aria-labelledby":"title-camera",children:e.jsx("div",{className:"control-group",children:e.jsxs("label",{className:"checkbox-label",children:[e.jsx("span",{children:"Orbit Camera"}),e.jsx("input",{"data-augmented-ui":"border tl-clip br-clip",type:"checkbox",checked:ee,onChange:n=>F(n.target.checked)})]})})})]}),e.jsxs("footer",{"data-augmented-ui":"bl-clip b-clip br-clip",className:"controls-footer",children:[e.jsx("button",{"data-augmented-ui":"br-clip tr-clip tl-clip bl-clip border",onClick:Te,className:"button reset-button",title:"Reset all settings to their default values",children:"Reset to Defaults"}),e.jsx("button",{"data-augmented-ui":"br-clip tr-clip tl-clip bl-clip border",onClick:o,className:"button fullscreen-button",title:"Toggle Full Screen",children:"Toggle Full screen"})]})]})})]})},jt=({size:o=60,color:t="var(--accent-color)",thickness:r=6})=>{const u={width:o,height:o,borderWidth:`${r}px`,borderLeftColor:t,marginTop:-(o/2)};return e.jsx("div",{style:u,className:"loading-spinner"})},Ot=()=>{const o=Se(),t=vt(),[r,u]=i.useState(!1),l=600;i.useEffect(()=>{u(!0);const _=setTimeout(()=>{u(!1)},l);return()=>clearTimeout(_)},[t,o==null?void 0:o.active]);const c=()=>{o!=null&&o.active?o.exit():o.enter()};return e.jsx(e.Fragment,{children:e.jsx(Ae,{handle:o,children:e.jsxs("div",{className:"app",children:[r?e.jsx(jt,{}):e.jsx(Dt,{}),e.jsx(Rt,{onFullScreen:c})]})})})};Ne.createRoot(document.getElementById("root")).render(e.jsx(Ot,{}));
